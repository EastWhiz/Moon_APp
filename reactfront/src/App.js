...
const App = () => {
  ...
  // const handleCardBackground = (index) => {
  //   setCardBackground(index); 
  // };

  const [designs, setDesigns] = useState([
    { background: "black", moon: "full1.png", color: "white", smMoon: "m1.png", active: true },
    { background: "white", moon: "full2.png", color: "black", smMoon: "m2.png", active: false },
    { background: "white", moon: "full3.png", color: "black", smMoon: "m3.png", active: false },
    { background: "white", moon: "full4.png", color: "black", smMoon: "m4.png", active: false },
    { background: "url('desert_orange.png')", moon: "full5.png", color: "white", smMoon: "m5.png", active: false },
    { background: "url('underwater_blue.png')", moon: "full6.png", color: "white", smMoon: "m6.png", active: false },
  ]);

  const handleDesigns = (index) => {
    setDesigns(index);
  };
            ...
            {value === 0 &&
              <div>
                <Box sx={{ p: 2, }}>
                  ...
                  <Grid2 container spacing={2.5}>
                    {["/large-size.png", "/small-size.png"].map((imageSrc, index) => (
                      <Grid2 item key={index}>
                        <Box
                          component="img"
                          src={imageSrc}
            ...
            {value === 3 &&
              <div>
                <Box sx={{ p: 2 }}>
                  ...
                  <Grid2 container spacing={2.5}>
                    {["/no-border.png", "/black-border.png", "/light-border.png"].map((imageSrc, index) => (
                      <Grid2 item key={index}>
                        <Box
                          component="img"
                          src={imageSrc}
